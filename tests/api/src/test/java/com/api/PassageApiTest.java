...
public class PassageApiTest {
    ...
    public void shouldReturn200ForOneVerse(){
        ...
        ApiTest.getShouldReturn200(PASSAGE_URL + "/John%203:16", LOGGER);
    ...
    public void shouldReturn200ForMultipleVerses(){
        ...
        ApiTest.getShouldReturn200(PASSAGE_URL + "/John%201:14-18", LOGGER);
    ...
    public void shouldReturn404ForNonexistingBook(){
        ...
        ApiTest.getShouldReturn404(PASSAGE_URL + "/BadBook%204:4", LOGGER);
    ...
    public void shouldReturn400ForChapterOutOfRange(){
        ...
        ApiTest.getShouldReturn400(PASSAGE_URL + "/John%2033:4", LOGGER);
    ...
    public void shouldReturn400ForVerseOutOfRange(){
        ...
        ApiTest.getShouldReturn400(PASSAGE_URL + "/John%205:99", LOGGER);
    ...
    public void shouldReturn400ForInvalidVerseRange(){
        ...
        ApiTest.getShouldReturn400(PASSAGE_URL + "/John%207:4-2", LOGGER);
